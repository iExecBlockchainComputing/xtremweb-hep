...
public final class DBCommandActivateWorker extends DBCommand implements CommCallback {
	 ...
	 */
	public DBCommandActivateWorker(final DBInterface dbi) throws IOException {
		super();
		dbInterface = dbi;
	}
	...
	public XMLable exec(final XMLRPCCommand command)
		...
		mileStone.println("<activateworker>");
		try {
			return new XMLtuple("activation", new Boolean(dbInterface.activateWorker(command)));		
		} finally {
			mileStone.println("</activateworker>");
		}
	}
